 ...
 * @author John
 */
@WebServlet(name = "loadEditProperty", urlPatterns = {"/loadEditProperty"})
public class loadEditPropertyController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("agent/editProperty.jsp");
