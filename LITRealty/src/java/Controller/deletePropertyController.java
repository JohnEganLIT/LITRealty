...
public class deletePropertyController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            Properties p = PropertiesDB.getPropertyByID(Integer.parseInt(request.getParameter("id")));
            ...
            RequestDispatcher rd = request.getRequestDispatcher("agent/deleteSuccessful.jsp");
